...
export type AstNode = RecordNode | FnNode | EnumNode | DeriveNode | GrammarNode | ExtractNode | TTableNode | NetworkNode;
// ⊕ PredicateNode | ParameterNode | LLMFnNode | … as modules land
