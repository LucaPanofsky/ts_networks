...
describe("compileProgram", () => {
  const program: ProgramAST = {
    records: [vec2], fns: [addFn], networks: [], derives: [], llmFns: [], enums: [docType], grammars: [], parameters: [],
  };
  ...
  test("empty program emits only the builtins preamble and a bare return", () => {
    const out = compileProgram({ records: [], fns: [], networks: [], derives: [], llmFns: [], enums: [], grammars: [], parameters: [] });
